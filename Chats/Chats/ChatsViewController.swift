...
class ChatsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        account.chats = [
            ...
            Chat(user: User(ID: 23, name: "Ben Lu"), lastMessageText: "I have no profile picture.", lastMessageSentDate: NSDate()),
            Chat(user: User(ID: 4, name: "Aghbalu Amghar"), lastMessageText: "Damn", lastMessageSentDate: NSDate(timeIntervalSinceNow: -hour*13)),
            Chat(user: User(ID: 22, name: "中文 日本語 한국인"), lastMessageText: "I have no profile picture or ASCII initials.", lastMessageSentDate: NSDate()),
